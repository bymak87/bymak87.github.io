...
prepare students to become full-stack developers. Tech stack focus was on learning Ruby on Rails, Javascript, HTML, CSS, and SQL</p>
      ...
      >
        <div className="w-100">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              <h3 className="mb-0">Sandbox Commerce</h3>
              <div className="subheading mb-3">Sandbox Commerce Platform</div>
              <p>
              I worked on the front end for the platform. I was mainly in charge of getting our
platform to look exactly like the Photoshop/Invision mockups of the redesign. I also
used various javascript libraries and jQuery to enable certain desired functionality.
